...
console.log("Question #10 ", concatenatedString);
...
console.log("Question #11 ", numbersGreaterThan3);
...
for (let number of squaresOfNumbers) {
...
for (let number of numbersFromBible) {
  if (number % 5 === 0) {
